(async () => {
        ...
        const STORAGE_KEY_DELAY = 'TCbình_redirect_delay';
        const STORAGE_KEY_LANG = 'lang';
        const STORAGE_KEY_AUTO = 'TCbình_auto_redirect';
...
input:checked + .toggle-slider {
    background: linear-gradient(135deg, #00aaff 0%, #6366f1 100%);
    border-color: #00aaff;
    ...
    <div class="panel-body" id="panel-body">
      ...
      <div class="info-section">
        ...
        <div class="links">
          ...
          <a href="https://discord.gg/m2H2nFzz" target="_blank">Discord</a>
        </div>
      </div>
    </div>
  </div>
