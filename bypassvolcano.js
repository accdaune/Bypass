        ...
        createPanel() {
            ...
            style.textContent = `
                * { margin: 0; padding: 0; box-sizing: border-box; }
                ...
                .panel {
                    background: linear-gradient(135deg, #3b0b0b 0%, #ff3b00 100%);
                    border-radius: 16px;
                ...
                .status-dot.info { background: #ff7043; }
                .status-dot.success { background: #ff5722; }
                .status-dot.warning { background: #ff9800; }
                .status-dot.error { background: #ff3b00; }
